...
// ACTIONS
export const REQUEST_PLACEHOLDER = 'placeholder/duck/REQUEST_PLACEHOLDER'
export const RECEIVE_PLACEHOLDER = 'placeholder/duck/RECEIVE_PLACEHOLDER'
export const FAILURE_PLACEHOLDER = 'placeholder/duck/FAILURE_PLACEHOLDER'
